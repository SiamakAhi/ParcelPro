                ...
                value: function () {
                  ...
                  return (
                    ...
                    n.year.indexOf(e) > -1
                      ...
                      ? (e = "second")
                      : n.millisecond.indexOf(e) > -1 && (e = "millisecond"),
                    { unit: e, value: t }
                  );
                },
              },
                  ...
                  value: function (e) {
                    return (
                      ...
                      "algorithmic" == this.leapYearMode
                        ...
                        ? ((e[1] = e[1] - 1), this.algorithms.calcGregorian(e))
                        : void 0
                    );
                  },
                },
          ...
          return (
            r(e, [
              ...
              },
              {
                key: "calcPersiana",
                value: function (e) {
                  (e[0] || 0 === e[0]) && (this.State.persianAstro.year = e[0]),
                    (e[1] || 0 === e[1]) &&
...
var FullCalendar = (function (exports) {
  ...
  var DateEnv = /** @class */ (function () {
    ...
    DateEnv.prototype.startOfMonth = function (m) {
      ...
      // var p=new persianDate(new Date(moment(m).format("YYYY-MM-DD")));
      // return p.toDate();
    };
  ...
  var DateProfileGenerator = /** @class */ (function () {
    ...
    DateProfileGenerator.prototype.buildPrev = function (
      ...
      if (currentDateProfile.currentRangeUnit == "month") {
        var p = new persianDate(currentDate);
        p.date(6);
        p.month(p.month() - 1);
        var prevDate = p.toDate();
    ...
    DateProfileGenerator.prototype.buildRangeFromDuration = function (
      ...
      function computeRes() {
        if (dateAlignment == "month") {
          ...
          if (d1.getDate() < s.toDate().getDate()) {
            d1.setDate(d1.getDate() + 1);
          } else if (d1.getDate() > s.toDate().getDate()) {
            d1.setDate(d1.getDate() - 1);
          }

          s = new persianDate(d1);

          var d2 = e.toDate();
          d2 = startOfDay(d2);

          if (d2.getDate() < e.toDate().getDate()) {
            d2.setDate(d2.getDate() - 1);
          } else if (d2.getDate() > e.toDate().getDate()) {
            d2.setDate(d2.getDate() + 1);
          }

          e = new persianDate(d2);
          ...
          const yearToJalali = new Date(date)
            .toLocaleDateString("fa-IR-u-nu-latn")
            .split("/")[0];
          const diffInMs = e.toDate() - s.toDate();
          const diffInDays = diffInMs / (1000 * 60 * 60 * 24);

          const isLeapYear = isLeapYearJalali(yearToJalali);
          const currentMonthName = s
            .toDate()
          ...
          if (
            ...
            e.toDate().setDate(e.toDate().getDate() - 1);
          }

          res = { start: s.toDate(), end: e.toDate() };
          /*console.log(date, { start: s.toDate(), end: e.toDate() });*/
        } else {
          start = dateEnv.startOf(date, dateAlignment);
          end = dateEnv.add(start, duration);
